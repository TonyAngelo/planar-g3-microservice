...
func GetHardwareInfo(address string, pooled bool) (structs.HardwareInfo, *nerr.E) {
	...
	// firmwareBytes, err := queryState("SYSTEM.VERSION?", address, true)
	// if err != nil {
	...
	//firmwareString = toString(firmwareBytes)
	//toReturn.FirmwareVersion = strings.Trim(firmwareString.String(), "\"")
